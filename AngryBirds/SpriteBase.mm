...
-(void)destoryPig{
    //CCSprite *score = [CCSprite spriteWithFile:[NSString stringWithFormat:@"goodjob.png"]];
    /* string with nothing but has no idea now... */
    CCLabelBMFont* score = [CCLabelBMFont labelWithString:@"" fntFile:@"konqa32.fnt"];
    score.scale = 0.2;
...
-(void) destoryEGG{
    ...
    CCLabelBMFont* score = [CCLabelBMFont labelWithString:@"Oh My God!" fntFile:@"konqa32.fnt"];
    score.scale = 0.2;
    score.position = self.position;
...
-(void) destory {
    ...
    switch (self.tag) {
        case BIRD_ID:
            //[label setString:@"Good Job"];
            //[label setColor:ccc3(250, 250, 0)];
